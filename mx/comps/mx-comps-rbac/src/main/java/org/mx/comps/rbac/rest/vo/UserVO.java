...
public class UserVO extends BaseVO {
    ...
    public static void transform(User user, UserVO userVO) {
        ...
        if (user.getSubordinates() != null && !user.getSubordinates().isEmpty()) {
            userVO.subordinates = transformUserVOs(user.getSubordinates());
        }
    }
    ...
    public static void transform(UserVO userVO, User user) {
        ...
        if (userVO.getSubordinates() != null && !userVO.getSubordinates().isEmpty()) {
            user.setSubordinates(UserVO.transformUsers(userVO.getSubordinates()));
        }
    }

    public static List<User> transformUsers(List<UserVO> userVOS) {
        if (userVOS == null) {
            return null;
        }
    ...
    public static List<UserVO> transformUserVOs(List<User> users) {
        if (users == null) {
            return null;
        }
    ...
    public List<UserVO> getSubordinates() {
        return subordinates;
    }

    public void setSubordinates(List<UserVO> subordinates) {
