...
Page({
  ...
  data: {
    ...
    spendingTime: formatDate(new Date()),
    courses: [],
    courseIndex: 0,
    owners: [],
    ownerIndex: 0
  ...
  bindTimeChange: function (e) {
    let data = this.data
    data.spendingTime = e.detail.value
    this.setData(data)
  },

  bindCourseChange: function (e) {
    let data = this.data
    data.courseIndex = e.detail.value
    this.setData(data)
  },

  bindOwnerChange: function (e) {
    let data = this.data
    data.ownerIndex = e.detail.value
    this.setData(data)
  },

  bindSaveSpending: function (e) {
